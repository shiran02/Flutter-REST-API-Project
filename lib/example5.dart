...
import 'package:flutter_api_project/Models/products_model.dart';
...
class _ExampleFiveState extends State<ExampleFive> {
  ...
  Future<ProductsModel> getProductApi () async{
    final response = await http.get(Uri.parse('https://webhook.site/36fb77b5-f7cb-490f-9681-384f3dc98214'));
